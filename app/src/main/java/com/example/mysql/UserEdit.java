...
public class UserEdit extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UserEdit.this, WelcomeNew.class));
    ...
    public void update_user(View view){
        ...
        class Update extends AsyncTask<Void, Void, String>{
            ProgressDialog pdLoading = new ProgressDialog(UserEdit.this);
            ...
            protected void onPostExecute(String s){
                ...
                try{
                    ...
                    if (!obj.getBoolean("error")){
                        Toast.makeText(UserEdit.this, obj.getString("message"), Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e ){
                    Toast.makeText(UserEdit.this, "Exception: "+e, Toast.LENGTH_SHORT).show();
                }
            }
        }
